import{E as p,U as ht,T as de,F as ft,x as Re,y as Ue,M as P,l as G,d as Be,K as w,t as R,a9 as re,R as ne,w as q,J as Me,a6 as I,a7 as Ge,c as A,B as C,D as L,ag as he,W as Q,ah as M,m as E,ai as pt,a1 as De,aj as fe,S as V,G as B,H as W,ak as mt,al as ie,O as J,am as k,s as se,a0 as Z,n as Ae,p as ze,ab as ke,ad as Oe,o as gt,q as xt,ac as _t,ae as bt,af as vt,an as yt,ao as Tt,ap as ee,aq as wt,ar as Ct,as as pe,e as y,at as Pt}from"./Index-EbvPB6km.js";import{c as Y,a as St,b as Ft,B as Ie}from"./colorToUniform-3MxHuUz8.js";import"./i18n-B3JWGZHu.js";import"./index-yXVd8EKt.js";import"./misc-Sk-ufXob.js";import"./ImagePreview-kGm_xXpH.js";import"./ScrollFade.svelte_svelte_type_style_lang-DtOW0AJa.js";import"./snippet-D4B_MRR0.js";import"./BlockLabel-C5f0w2ZL.js";import"./DownloadLink-Da8s1DUm.js";import"./Empty-DHvjHR2S.js";import"./ShareButton-VEPopqk_.js";import"./Download-BnaC4vvG.js";import"./Image-Bvt7FPzD.js";import"./IconButtonWrapper-C49x3JGc.js";import"./FullscreenButton-DnW5ceKB.js";import"./Maximize-D3-SvJI2.js";import"./Image-qjTg-HzW.js";/* empty css                                            *//* empty css                                                   */import"./Block-mqXS8Poa.js";import"./index-DdqQhAtx.js";import"./StreamingBar.svelte_svelte_type_style_lang-BaPvPIGD.js";import"./html-DY1zcnE_.js";import"./index-B_pwUImq.js";import"./Clear-B7_nEoLK.js";/* empty css                                                    */import"./Upload-ZjOARLnG.js";import"./actions-aIcK657N.js";/* empty css                                              */import"./Webcam-DbvVykD7.js";import"./DropdownArrow-BC5HLiU-.js";import"./Square-BKd6POUU.js";import"./Spinner-DHdWJY6R.js";import"./StreamingBar-ChZJhVax.js";import"./window-B3kZH1ca.js";import"./tinycolor-DHLU_Gx5.js";import"./Plus-CqK_mU_D.js";import"./input-CYDqnPsc.js";import"./Check-LwUg4DVz.js";import"./event-modifiers-CdEA5IGF.js";import"./ArrowUp-BJ7wRy1n.js";import"./Trash-DB7Xk_VO.js";import"./Undo-Dd6j_PVD.js";class Ee{static init(e){Object.defineProperty(this,"resizeTo",{configurable:!0,set(t){globalThis.removeEventListener("resize",this.queueResize),this._resizeTo=t,t&&(globalThis.addEventListener("resize",this.queueResize),this.resize())},get(){return this._resizeTo}}),this.queueResize=()=>{this._resizeTo&&(this._cancelResize(),this._resizeId=requestAnimationFrame(()=>this.resize()))},this._cancelResize=()=>{this._resizeId&&(cancelAnimationFrame(this._resizeId),this._resizeId=null)},this.resize=()=>{if(!this._resizeTo)return;this._cancelResize();let t,r;if(this._resizeTo===globalThis.window)t=globalThis.innerWidth,r=globalThis.innerHeight;else{const{clientWidth:n,clientHeight:i}=this._resizeTo;t=n,r=i}this.renderer.resize(t,r),this.render()},this._resizeId=null,this._resizeTo=null,this.resizeTo=e.resizeTo||null}static destroy(){globalThis.removeEventListener("resize",this.queueResize),this._cancelResize(),this._cancelResize=null,this.queueResize=null,this.resizeTo=null,this.resize=null}}Ee.extension=p.Application;class Ve{static init(e){e=Object.assign({autoStart:!0,sharedTicker:!1},e),Object.defineProperty(this,"ticker",{configurable:!0,set(t){this._ticker&&this._ticker.remove(this.render,this),this._ticker=t,t&&t.add(this.render,this,ht.LOW)},get(){return this._ticker}}),this.stop=()=>{this._ticker.stop()},this.start=()=>{this._ticker.start()},this._ticker=null,this.ticker=e.sharedTicker?de.shared:new de,e.autoStart&&this.start()}static destroy(){if(this._ticker){const e=this._ticker;this.ticker=null,e.destroy()}}}Ve.extension=p.Application;var Rt=`in vec2 aPosition;
